...
class Shop extends Component {
  render() {
    const { lang,getTrans } = this.props;

    return (
      <section className='shop-container' >
        <HeaderWithouImge title={getTrans('Shop')} />
        <div className='underconstruction'>
          <div className='warning-content'>
            <h1 className='shop__title'>{ lang === 'Ar' ? 'المتجر قيد الإنشاء' : 'Shop Page is Under Construction'}</h1>
            <svg version='1.1' xmlns='http://www.w3.org/2000/svg' x='0' y='0' width='150.001' height='100' viewBox='0 0 100 68'>
              <g id='large'>
              	<g>
...
export default connect(mapStateToProps, navActions)(Shop);
